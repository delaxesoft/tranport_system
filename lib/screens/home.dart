...
class _HomeState extends State<Home> {
  ...
  // create a text controller for search
//configure mapbox search
  ...
  void initState() {
    ...
    // initialize MapboxPlaceSearch instance
                    ...
                    Center(
                      child: Column(
                        ...
                        children: [
                                ...
                                ? () async {
                                    ...
                                    await _navigationWithMapboxPlugin
                                        .startNavigation(
                                            ...
                                            msg: 'Welcome to smart transport!');
                                  }
                                : null,
                          ...
                          // add the MapboxPlaceSearch widget
                        ],
                      ),
                    ),
...
//I need to set permision on mapbox to enable this to work
...
import 'package:smart_tranport_system/widgets/endpoints_card.dart';
import 'package:smart_tranport_system/widgets/search_listview.dart';
...
class _PrepareRideState extends State<PrepareRide> {
  ...
  set responseState(List responses) {
    setState(() {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
          ...
          title: const Text('Smart Transport System'),
          actions: const [
            CircleAvatar(
                backgroundImage: AssetImage('assets/image/sport-car.png')),
          ]),
      body: SafeArea(
        child: SingleChildScrollView(
            ...
            child: Column(
              children: [
                endpointsCards(sourceController, destinationController),
                isLoading

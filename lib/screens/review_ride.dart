...
import 'package:smart_tranport_system/helpers/mapbox_handler.dart';
import 'package:smart_tranport_system/helpers/shared_prefs.dart';
        ...
        child: Stack(
          children: [
            SizedBox(
              ...
              child: MapboxMap(
                accessToken:
                    'pk.eyJ1IjoiZGVsYXhlc29mdCIsImEiOiJjbDlweDZyNGQwM28zM3BsN3ExczAzbG00In0.bXel-PZA2yAiBaFvZkwRiw',
